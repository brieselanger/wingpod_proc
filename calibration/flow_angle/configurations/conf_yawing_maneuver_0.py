...
data_dir = '/home/axel/5Loch/flights/testflights/20170809/testflight_2/'

#MODULES DIRECTORY
#
#Where the modules for data processing are located.
mod_dir = '/home/axel/Dropbox/Dokumente/studium/WeWi/5Loch/python/'

#OUTPUT DIRECTORY
#
#Select directory for all output files (kml, kmz and csv export).
out_dir = '/home/axel/5Loch/flights/testflights/20170809/testflight_2/'

#SELECT TIME
#
#Select a timestamp in format "['YYYY-MM-DD HH:MM', 'YYYY-MM-DD HH:MM']" in
...
#GPS-time in UTC.
time_sel = ['2017-08-09 17:07:31', '2017-08-09 17:07:52'] #default: []
